...
include("dbconn.php");
  ...
  $value=$_FILES[image1][name];
       ...
       break; 
					...
					copy($_FILES[image1][tmp_name], $add);
...
else
{
 echo" You have 0 Images to be tagged!";
                 ...
                 /**echo"Please Wait...You will be directed to the Tag image Page.";
                  echo"<p>If you are not redirected,<a href='../UploadMenu.php'>Click Here</a></p>";
                  //using javascript to redirect to tag image page
                  print "<script>";
                  print " self.location='../UploadMenu.php';";
                  print "</script>";         */
                 } 
               else 
            { 
