<?php
include('other.php');
function createHomeAlbumview($albumid,$jumpto)
...
xajax_HideImageDetailDiv();xajax_showHome();\">Back&nbsp;&nbsp;</a></td>";
	...
	if($num==0)
		...
		$result  = mysql_query($query) or die('Error, query failed'); 
				...
				if ($pageNum > 1) 
						{ 
							$page = $pageNum -1; 
							$prev="<input type=\"button\" name=\"prev\" onclick =\"xajax_createHomeAlbumview($albumid,$page);\" value=\"Prev\">"; 

							$first = "<input type=\"button\" name=\"first\" onclick =\"xajax_createHomeAlbumview($albumid,1);\" value=\"First\">";  
				...
				if ($pageNum < $maxPage) 
						{ 
						$page = $pageNum + 1; 
						$next = "<input type=\"button\" name=\"next\"onclick=\"xajax_createHomeAlbumview($albumid,$page);\"value=\"Next\">";  
						$last = "<input type=\"button\" name=\"Last\"onclick=\"xajax_createHomeAlbumview($albumid,$maxPage);\"value=\"Last\">";   
