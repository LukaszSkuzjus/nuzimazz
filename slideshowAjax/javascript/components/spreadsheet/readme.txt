BlueShoes JavaScript SpreadSheet Component
==========================================
...
NOTE: 
 ...
 - If you use this as standalone package then you may want to 
   ...
   /_bsJavascript/components/spreadsheet/) to something else. 
   see the examples.
...
TODO:
  ...
  - fix a bug with inserting a row when the cursor is in the last row.
