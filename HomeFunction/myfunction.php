...
{//display a picture of an album
					...
					for($i =0;$i<5;$i++)
		{
				...
				$msg.="<td><table class=\"table-shadows\" >
					...
					<a href=\"javascript:void(null);\"onclick =\"xajax_ShowGallery();xajax_createAlbumView($albumId,'');xajax_RateAlbum($albumId);makeHistory(1);\">";//end of echo
					//GetImage path 
      ...
      $myarray = array();
       $i =0;
		...
		$msg="<table class=\"table-shadows\" >
					...
					<a href=\"javascript:void(null);\"onclick =\"xajax_ShowGallery();xajax_createHomeAlbumview($albumId,'');xajax_RateAlbum($albumId);\">";//end of echo
					//GetImage path 
					$msg.="<IMG SRC=\"$path\"width=130 height=130
					align= \"center\" >
					</a>
